...
## How to create and respond to conversations <a href="#create-and-respond-to-conversations" id="create-and-respond-to-conversations"></a>
...
4. Choose whether to reply to the group or individually:
   * To reply to the group, below the message text, click **Reply all**. Compose your reply![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn)click **Post Message**.
   * To reply only to the person who posted, below the message text, click **Reply to author**. Compose your reply![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn)click **Send.**&#x20;
   * To forward a message, below the message text, click **Forward**. Enter some message text![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn)click **Send.**
...
{% hint style="warning" %}
_Requires the Owner or Manager role._
{% endhint %}
...
1. Sign in to [Google Groups](https://groups.google.com/).
2. Click the name of a group.
3. On the left, go to **Group settings**![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn)**Email options**.
4. Under **Post replies to**, click the displayed option![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn)choose the option you want.
5. Click **Save changes**.

### How to delete a message

{% hint style="warning" %}
_Deleting messages from other members requires the **Who can moderate content** permission._
{% endhint %}

You can delete messages you posted, and possibly messages from other group members.

1. Open the message you want to delete.
2. In the message entry, click More![""](https://storage.googleapis.com/support-kms-prod/iwMAMe1lEk5FwSU7G8VhBiTE8PuXATWhvq8t)![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn)**Delete**.
3. In the confirmation box, click **OK**.

**Note**: If a post is inappropriate, you can [delete it and report it as abuse](https://support.google.com/groups/answer/81275).

### How to view unread messages

To see the number of unread messages for a group, set up a filter in your email client.

If Groups for Business is turned on, to see the number of unread messages for a group, your subscription option must be set to **Each email**. Visit [View and edit membership settings](https://support.google.com/a/users/answer/9303224#5.2).

Here are example instructions for Gmail.

1. In Gmail, [create a filter](https://support.google.com/mail/answer/6579#create\_filter).\
   In the search field, on the **To** line, enter the group's email address.
2. After clicking **Create filter**:
   1. Check the **Apply the label** box.
   2. Next to **Choose label**, click the Down arrow ![""](https://storage.googleapis.com/support-kms-prod/nvRYxnLDhMqCcJ2wkmNaAjYxVnH1FyoXo2Sb)![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn)**New label**.
   3. In the first field, enter the group's name.\
...
* **Change your settings**—If the **Add me to their groups** setting is on, a group manager can add you to a group without your permission and then send you messages from that group. Stop people from directly adding you to a group by following the instructions in [I'm in groups I didn't join](https://support.google.com/groups/answer/10566756).
...
1. Sign in to [Google Groups](https://groups.google.com/).
2. Locate the group![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn) choose an option:
   * To stay in the group but stop getting email, for **Subscription**, click the displayed option![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn)select **No email**.
   * To leave the group and stop getting email, click Leave group ![""](https://storage.googleapis.com/support-kms-prod/6egtoYOCI40hLvldjTboYJrFRqgNehFsBO3F)![and then](https://storage.googleapis.com/support-kms-prod/Th2Tx0uwPMOhsMPn7nRXMUo3vs6J0pto2DTn)**Yes, leave group**.

### Unsubscribe and leave a group using email

To leave a group and stop getting email from it, you can send an email to _group name_+unsubscribe@_group domain_. For example, to leave the group **mygroup@googlegroups.com**, you would send a message to **mygroup+unsubscribe@googlegroups.com**. You can send the request with no subject or body text.
